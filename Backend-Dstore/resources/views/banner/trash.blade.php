                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex gap-3 align-content-center">
                            <a href="{{route('admin.banner.index')}}"> <i class="fa-solid fa-arrow-left fs-20"></i></a>
                            <h5 class="card-title mb-0">Danh sách banner đã xóa</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.banner.restore',$banner->id)}}"
                                                       class="dropdown-item edit-item-btn">
                                                        <i class="fa-solid fa-arrows-rotate me-2 text-muted"></i>
                                                        Khôi phục</a>
                                                </li>
                                                <li>
