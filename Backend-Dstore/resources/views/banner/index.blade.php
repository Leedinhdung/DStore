                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-grid gap-3">
                            ...
                            <a href="{{route('admin.banner.trash')}}">Thùng rác</a>
                        </div>
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        ...
                        @foreach($banners as $banner)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (!empty($banner->url))
                                        <img src="{{ $banner->url }}" width="100px" alt="">
                                    @else
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{route('admin.banner.edit',$banner->id)}}" class="dropdown-item edit-item-btn"><i
                                                            class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Sửa</a></li>
                                            <li>
                                                <a href="{{route('admin.banner.softDelete',$banner->id)}}" class="dropdown-item remove-item-btn">
