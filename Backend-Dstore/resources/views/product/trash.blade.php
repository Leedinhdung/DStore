                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{route('admin.product.restore',$product->id)}}" class="dropdown-item"><i
                                                            class="fa-solid fa-arrows-rotate me-2 text-muted"></i> Khôi phục</a>
                                            </li>
                                            <li>
                                                <a href="{{route('admin.product.destroy',$product->id)}}" class="dropdown-item remove-item-btn">
