                        ...
                        <div class="row">
                            ...
                            <div class=" col-4 mb-3">
                                ...
                                <select class="form-select" name="condition">
                                    ...
                                    <option value="outofstock" {{ old('condition', $product->condition ?? '') == 'outofstock' ? 'selected' : '' }}>Hết hàng</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class=" col-4 mb-3">
                                ...
                                <input type="number" step="10000" class="form-control" name="original_price" value="{{old('original',$product->original_price)}}"
                            ...
                            <div class=" col-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="sale_price" value="{{old('sale_price',$product->sale_price)}}"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="variants[0][color]"
                                                   placeholder="e.g. Black" value="{{old('color',$variant->color)}}" >
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        @forelse($variant->images as $image)
                                            <img src="{{ Storage::url($image->image_path) }}" alt="Variant Image" style="width: 80px; height: 80px; object-fit: cover;">
                                        @empty
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="ckeditor-full">{{old('description',$product->description)}}</textarea>
                            @error('description')
                            <div class="text-danger my-2"> {{$message}} </div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="specification" id="ckeditor-specs">{{old('specification',$product->specification)}}</textarea>
                            @error('specification')
                            <div class="text-danger my-2"> {{$message}} </div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="text-center">
                                ...
                                <div class="mx-auto">
                                    <img src="{{ Storage::url($product->image) }}" alt="Ảnh chính của sản phẩm" style="max-height: 200px; border: 1px solid #ddd; padding: 4px; margin-top: 10px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        >
                            @foreach($categories as $parent)
                                <option
                                    value="{{ $parent->id }}" {{ old('parent_id', $product->category_id ?? '') == $parent->id ? 'selected' : '' }}>
                                    {{ $parent->name }}
                                </option>
                                @if ($parent->children)
                                    @foreach ($parent->children as $child)
                                        <option
                                            value="{{ $child->id }}" {{ old('parent_id', $product->category_id ?? '') == $child->id ? 'selected' : '' }}>
                                            - {{ $child->name }}
                                        </option>
                                    @endforeach
                                @endif
